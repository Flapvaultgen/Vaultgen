...
// forge test --match-path test/_codegen/AutomatedBuybackVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — AutomatedBuybackVault
...
/// @title AutomatedBuybackVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated AutomatedBuybackVault via CodegenVaultFactory.
contract AutomatedBuybackVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "AutomatedBuybackVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("AutomatedBuybackVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "AutomatedBuybackVault:Token");
        vm.label(vault, "AutomatedBuybackVault:Vault");
    }

    function test_AutomatedBuybackVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_AutomatedBuybackVault_buyAndDispatch() public {
    ...
    function test_AutomatedBuybackVault_writeMethodsDocumented() public view {
        // Documents scheduleBuyback, trigger, executeBuyback for AutomatedBuybackVault audit trail (Rule 006).
