...
// forge test --match-path test/_codegen/NieuwHolderLotteryVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — NieuwHolderLotteryVault
...
/// @title NieuwHolderLotteryVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated NieuwHolderLotteryVault via CodegenVaultFactory.
contract NieuwHolderLotteryVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "NieuwHolderLotteryVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("NieuwHolderLotteryVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "NieuwHolderLotteryVault:Token");
        vm.label(vault, "NieuwHolderLotteryVault:Vault");
    }

    function test_NieuwHolderLotteryVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_NieuwHolderLotteryVault_buyAndDispatch() public {
    ...
    function test_NieuwHolderLotteryVault_writeMethodsDocumented() public view {
        // Documents enter, drawWinner, executeBuyback for NieuwHolderLotteryVault audit trail (Rule 006).
