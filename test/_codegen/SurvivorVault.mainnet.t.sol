...
// forge test --match-path test/_codegen/SurvivorVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — SurvivorVault
...
/// @title SurvivorVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated SurvivorVault via CodegenVaultFactory.
contract SurvivorVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "SurvivorVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("SurvivorVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "SurvivorVault:Token");
        vm.label(vault, "SurvivorVault:Vault");
    }

    function test_SurvivorVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_SurvivorVault_buyAndDispatch() public {
    ...
    function test_SurvivorVault_writeMethodsDocumented() public view {
        // Documents setAiModel, stake, requestElimination, lastRequestId, unstake for SurvivorVault audit trail (Rule 006).
