...
// forge test --match-path test/_codegen/BuybackVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — BuybackVault
...
/// @title BuybackVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated BuybackVault via CodegenVaultFactory.
contract BuybackVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "BuybackVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("BuybackVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "BuybackVault:Token");
        vm.label(vault, "BuybackVault:Vault");
    }

    function test_BuybackVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_BuybackVault_buyAndDispatch() public {
    ...
    function test_BuybackVault_writeMethodsDocumented() public view {
        // Documents executeBuyback, withdrawTreasury for BuybackVault audit trail (Rule 006).
