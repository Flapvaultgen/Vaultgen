...
// forge test --match-path test/_codegen/DualPoolStakingVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — DualPoolStakingVault
...
/// @title DualPoolStakingVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated DualPoolStakingVault via CodegenVaultFactory.
contract DualPoolStakingVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "DualPoolStakingVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("DualPoolStakingVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "DualPoolStakingVault:Token");
        vm.label(vault, "DualPoolStakingVault:Vault");
    }

    function test_DualPoolStakingVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_DualPoolStakingVault_buyAndDispatch() public {
    ...
    function test_DualPoolStakingVault_writeMethodsDocumented() public view {
        // Documents stake, unstake, claimReward for DualPoolStakingVault audit trail (Rule 006).
