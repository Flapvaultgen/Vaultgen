...
// forge test --match-path test/_codegen/SimpleTreasuryVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — SimpleTreasuryVault
...
/// @title SimpleTreasuryVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated SimpleTreasuryVault via CodegenVaultFactory.
contract SimpleTreasuryVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "SimpleTreasuryVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("SimpleTreasuryVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "SimpleTreasuryVault:Token");
        vm.label(vault, "SimpleTreasuryVault:Vault");
    }

    function test_SimpleTreasuryVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_SimpleTreasuryVault_buyAndDispatch() public {
    ...
    function test_SimpleTreasuryVault_writeMethodsDocumented() public view {
        // Documents withdrawTreasury for SimpleTreasuryVault audit trail (Rule 006).
