...
// forge test --match-path test/_codegen/MilestoneBurnVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — MilestoneBurnVault
...
/// @title MilestoneBurnVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated MilestoneBurnVault via CodegenVaultFactory.
contract MilestoneBurnVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "MilestoneBurnVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("MilestoneBurnVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "MilestoneBurnVault:Token");
        vm.label(vault, "MilestoneBurnVault:Vault");
    }

    function test_MilestoneBurnVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_MilestoneBurnVault_buyAndDispatch() public {
    ...
    function test_MilestoneBurnVault_writeMethodsDocumented() public view {
        // Documents executeBuyback for MilestoneBurnVault audit trail (Rule 006).
