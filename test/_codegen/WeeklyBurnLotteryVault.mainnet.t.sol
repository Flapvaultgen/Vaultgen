...
// forge test --match-path test/_codegen/WeeklyBurnLotteryVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — WeeklyBurnLotteryVault
...
/// @title WeeklyBurnLotteryVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated WeeklyBurnLotteryVault via CodegenVaultFactory.
contract WeeklyBurnLotteryVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "WeeklyBurnLotteryVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("WeeklyBurnLotteryVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "WeeklyBurnLotteryVault:Token");
        vm.label(vault, "WeeklyBurnLotteryVault:Vault");
    }

    function test_WeeklyBurnLotteryVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_WeeklyBurnLotteryVault_buyAndDispatch() public {
    ...
    function test_WeeklyBurnLotteryVault_writeMethodsDocumented() public view {
        // Documents enter, requestDraw, lastRequestId, executeBuyback, setAiModel for WeeklyBurnLotteryVault audit trail (Rule 006).
