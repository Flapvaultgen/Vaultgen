...
// forge test --match-path test/_codegen/KingOfTheHillVault.mainnet.t.sol -vvv --fork-url https://bsc-dataseed.bnbchain.org
// Auto-generated by Codegen Studio for Rule 006 — KingOfTheHillVault
...
/// @title KingOfTheHillVaultMainnetTest
/// @notice Mainnet-fork integration tests for AI-generated KingOfTheHillVault via CodegenVaultFactory.
contract KingOfTheHillVaultMainnetTest is FlapBSCFixture {
    ...
    function setUp() public {
        ...
        creationCode = vm.readFileBinary(string.concat("test/_codegen/", "KingOfTheHillVault.bin"));
        ...
        IVaultPortalTypes.NewTokenV6WithVaultParams memory params =
            _buildV3TaxTokenParams("KingOfTheHillVault Token", "CGEN", salt, address(factory), creationCode);
        ...
        vm.label(token, "KingOfTheHillVault:Token");
        vm.label(vault, "KingOfTheHillVault:Vault");
    }

    function test_KingOfTheHillVault_factoryDeploysVault() public view {
        assertTrue(vault != address(0), "vault deployed");
        assertTrue(taxProcessorAddr != address(0), "tax processor wired");
    }

    function test_KingOfTheHillVault_buyAndDispatch() public {
    ...
    function test_KingOfTheHillVault_writeMethodsDocumented() public view {
        // Documents stake, unstake, claimReward for KingOfTheHillVault audit trail (Rule 006).
